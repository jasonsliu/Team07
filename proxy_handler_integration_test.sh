...
PROXY_CONFIG="port 2021; path /proxy SpaceteamProxyHandler { host localhost; proxy_port 2022; } default NotFoundHandler {}"
HOST_CONFIG="port 2022; path /static file_handler { root files; } default NotFoundHandler {}"
